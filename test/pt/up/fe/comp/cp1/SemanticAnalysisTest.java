...
public class SemanticAnalysisTest {
    ...
    @Test
    public void varargsAsField() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/VarArgAsField.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }

    @Test
    public void varargsAsLocal() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/VarArgAsLocal.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    ...
    @Test
    public void staticAccessingField() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/StaticAccessingField.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    @Test
    public void staticAccessingMethod() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/StaticAccessingMethod.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    ...
    @Test
    public void lengthEverywhere() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/LengthEverywhere.jmm"));
        TestUtils.noErrors(result);
        System.out.println(result.getReports());
    }
}
